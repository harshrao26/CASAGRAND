    ...
    <header className="fixed z-[1000] top-4 left-1/2 -translate-x-1/2   w-full px-3 md:px-0">
      ...
      <div className="mx-auto max-w-8xl ">
        <div className="relative bg-white/90 py-1 flex items-center justify-between rounded-full   text-white shadow-[0_10px_30px_rgba(0,0,0,0.35)] ring-1 rin g-black/30 backdrop-blur-md">
          ...
          <nav className="hidden te md:flex items-center gap-8 font-medium px-4">
            {links.map((l) => (
              <Link
                key={l.href}
                href={l.href}
                className="hover:text-yellow-500/100 transition"
              >
                {l.label}
              </Link>
            ))}
          ...
          <div className="flex items-center gap-2 pr-2">
            ...
            <Link
              href="/contact-us"
              className=" w-full hidden md:block rounded-full bg-yellow-500 text-white font-medium px-3 py-[7px]   transition"
            >
              Contact Us
            </Link >
      ...
      {isOpen && (
        <div className="md:hidden mt-3 mx-auto max-w-7xl rounded-2xl bg-black/90 text-white ring-1 ring-black/30 backdrop-blur-md px-5 py-6 space-y-4">
          ...
          <Link
            href="/contact-us"
            className="mt- w-full rounded-full bg-yellow-500 text-xs text-white font-medium px-5 py-1 h  transition"
          >
            Contact Us
          </Link >
        </div>
