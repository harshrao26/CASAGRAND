                ...
                <div className="grid grid-cols-1 md:grid-cols-2 mt-10 lg:grid-cols-3 gap-8">
                    {properties.map((property) => (
                        ...
                        >
                            ...
                            <div className="relative h-[220px] sm:h-[300px] md:h-96 overflow-hidden rounded-t-xl mb-3 sm:mb-6">
                                {/* NEW Ribbon */}
                                <div className="absolute top-0 left-6 z-20">
                                    <div className="bg-[#1C8A9B] text-white text-[11px] font-semibold px-4 pt-2 pb-4 [clip-path:polygon(0_0,100%_0,100%_100%,50%_80%,0_100%)] widest relative shadow-lg">
                                        <span className="text-[12px] sm:text-[14px] font-medium tight">{property.location}</span>
